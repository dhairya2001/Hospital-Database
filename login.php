...
body {
  ...
  padding-top: 40px;
  padding-bottom: 40px;
  background-image: linear-gradient(180deg,lightgrey 49%,white 99%);
  height:100%;
}
...
<!--      <img class="mb-4" src="../../assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">-->
      ...
      <input class="btn btn-lg btn-dark btn-block" type="submit" name="login" value="LOGIN">
      <p class="mt-5 mb-3 text-muted">&copy; 2021 PCCOE</p>
    </form>
<?php
