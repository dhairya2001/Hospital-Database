  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="./update-patient.php">Patient</a>
          <a class="dropdown-item" href="./update-doctor.php">Doctor</a>
          <a class="dropdown-item" href="./update-department.php">Department</a>
          <a class="dropdown-item" href="./update-room.php">Room</a>
